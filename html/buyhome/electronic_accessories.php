	...
	<div class="wrapper">
		...
		<div class="row one">
			...
			<div class="col s9 buy_list">
				<div class="items card hoverable row"  onclick="itemdisplay('head_charg_power_cam_cal','headphones');">
				...
				<div class="items card hoverable row" onclick="itemdisplay('head_charg_power_cam_cal','powerbank');">
					<img src="../../img/buy/Icons/Electronics/Mobile.png" class="card-image circle responsive-img col s3">
					<div class="buy_list_title col s9">
							Powerbanks
					</div>
				</div>
				<div class="items card hoverable row" onclick="itemdisplay('head_charg_power_cam_cal','charger');">
					<img src="../../img/buy/Icons/Electronics/Mobile.png" class="card-image circle responsive-img col s3">
					<div class="buy_list_title col s9">
							Chargers
					</div>
				</div>
				<div class="items card hoverable row" onclick="itemdisplay('head_charg_power_cam_cal','calculator');">
