		...
		<div class="row one">
			...
			<div class="col s9 ">
				<div class="items col s3 center-align">
					<img src="../../img/buy/Icons/Electronics/Laptops.png" class="circle responsive-img hoverable" onclick="itemdisplay('mobile','laptop');">	
				</div>
				<div class="items col s3 center-align">
					<img src="../../img/buy/Icons/Electronics/Mobile.png" class="circle responsive-img hoverable" onclick="itemdisplay('mobile','mobile');">
				</div>
				<div class="items col s3 center-align">
					<img src="../../img/buy/Icons/Electronics/Tablet.png" class="circle responsive-img hoverable" onclick="itemdisplay('mobile','tablet');">
				</div>
			</div>
		</div>
		<div class="row">
