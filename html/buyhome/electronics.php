	...
	<div class="wrapper">
		...
		<div class="row one">
			...
			<div class="col s9 buy_list">
				<div class="items card hoverable row" onclick="itemdisplay('mobile_tablet_laptop','laptop');">
				...
				<div class="items card hoverable row" onclick="itemdisplay('mobile_tablet_laptop','mobile');">
					<img src="../../img/buy/Icons/Electronics/Mobile.png" class="card-image circle responsive-img col s3">
					<div class="buy_list_title col s9">
							Mobiles
					</div>
				</div>
				<div class="items card hoverable row" onclick="itemdisplay('mobile_tablet_laptop','tablet');">
