			...
			<div class="col s8 m8 sell_form">
				<form class="col s12" action="mobile_tablet_laptop_data.php" method="POST">
        			...
        			<div class="row">
        				...
        				<p>
					      <input type="checkbox" id="cover" name="accessories[]" value="Cover" />
					    ...
					    <p>
					      <input type="checkbox" id="usb" name="accessories[]" value="USB Card" />
					      <label for="usb">USB Cable</label>
					    </p>
					    <p>
					      <input type="checkbox" id="mem_card" name="accessories[]" value="Memory Card" />
					      <label for="mem_card">Memory Card</label>
					    </p>
					    <p>
