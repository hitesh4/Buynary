	...
	<div class="wrapper">
		<div class="row main_sell">
			...
			<div class="col s8 m8 sell_form">
				<form class="col s12" action="furniture_data.php" method="POST">
					<div class="row">
        				<label style="font-size:16px;color:#FFC400;">What is it that you want to sell?</label>
        				<p>
					      <input name="product" type="radio" id="guitar" value="Guitar" />
					      <label for="guitar">Guitar</label>
					    </p>
					    <p>
					      <input name="product" type="radio" id="casio" value="Casio" />
					      <label for="casio">Casio</label>
					    </p>
					    <p>
					      <input name="product" type="radio" id="drum_set" value="Drum-Set" />
					      <label for="drum_set">Drum-Set</label>
					    </p>
					    <p>
					      <input type="radio" name="product" value="Other1" id="other1" />
