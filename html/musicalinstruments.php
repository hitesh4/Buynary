			...
			<div class="col s8 m8 sell_form">
				<form class="col s12">
					<div class="row">
        				...
        				<p>
					      <input name="group1" type="radio" id="guitar" />
					      <label for="guitar">Guitar</label>
					    </p>
					    <p>
					      <input name="group1" type="radio" id="casio" />
					      <label for="casio">Casio</label>
					    </p>
					    <p>
					      <input name="group1" type="radio" id="drum_set" />
					      <label for="drum_set">Drum-Set</label>
					    </p>
					    <p>
					      <input name="group1" type="radio" id="otherm" />
