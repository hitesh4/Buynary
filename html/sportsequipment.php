			...
			<div class="col s8 m8 sell_form">
				<form class="col s12">
					<div class="row">
        				...
        				<p>
					      <input name="group1" type="radio" id="cricket" />
					      <label for="cricket">Cricket</label>
					    </p>
					    <p>
					      <input name="group1" type="radio" id="badminton" />
					      <label for="badminton">Badminton</label>
					    </p>
					    <p>
					      <input name="group1" type="radio" id="football" />
					      <label for="football">Football</label>
					    </p>
					    <p>
					      <input name="group1" type="radio" id="tennis" />
					      <label for="tennis">Tennis</label>
					    </p>
					    <p>
					      <input name="group1" type="radio" id="athletics" />
					      <label for="athletics">Athletics</label>
					    </p>
					    <p>
					      <input name="group1" type="radio" id="basketball" />
					      <label for="basketball">Basketball</label>
					    </p>
					    <p>
					      <input name="group1" type="radio" id="squash" />
					      <label for="squash">Squash</label>
					    </p>
					    <p>
					      <input name="group1" type="radio" id="tt" />
					      <label for="tt">TT</label>
					    </p>
					    <p>
					      <input name="group1" type="radio" id="swimming" />
					      <label for="swimming">Swimming</label>
					    </p>
					    <p>
					      <input name="group1" type="radio" id="skating" />
					...
					<div class="row">
					    <div class="input-field col s12">
					      ...
					      <label for="icon_name">What is the product?</label>
					   </div>
        			</div>
        			<div class="row">
					    <div class="input-field col s12">
					      ...
					      <label for="icon_author">What is the brand or product name?</label>
					   </div>
        			</div>
