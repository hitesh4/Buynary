		...
		<div class="row main_sell">
			...
			<div class="col s8 m8 sell_form">
				<form class="col s12" action="furniture_data.php" method="POST">
					<div class="row">
						<label style="font-size:16px;color:#FFC400;">What is the product?</label>
						<p>
						  <input name="product" type="radio" id="bean_bag" value="Bean Bag" />
						  <label for="bean_bag">Bean bag</label>
						</p>
						<p>
						  <input name="product" type="radio" id="chair" value="Chair" />
