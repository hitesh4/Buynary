$(document).ready(function(){
	var items = $('.buy_list').height();
    $('.side_content').css('height',items+15);
			...
			for(var i=0; i<length; i++) {
				switch(cat){
					case 'book':
						...
						//click_enabler();
						$('.check_item').append('<div class="row items card hoverable" style="width:80vw;"><div class="col s12 center-align"><div class="col s3 logo"><a class="modal-trigger" onClick=click_enabler('+i+') href="#modal1"><img src="http://placehold.it/150x150" class="waves-effect waves-light circle responsive-img hoverable"></a></div><div class="col s8"><div class="col s8"><div class="item_name">'+data[1][i][3]+'</div><div class="item_author">Author: '+data[1][i][4]+'</div><div class="item_edition">Edition: '+data[1][i][5]+'</div><div class="item_negotiable">Price Negotiable: '+data[0][i][0][10]+'</div></div><div class="col s4"><div class="item_price z-depth-1">Price: '+data[0][i][0][5]+'</div><div class="item_link"><a href="'+data[0][i][0][9]+'">E-commerce Link</a></div></div></div></div></div>');
					...
					case 'mobile_tablet_laptop':
						$('.check_item').append('<div class="row items card hoverable" style="width:80vw;"><div class="col s12 center-align"><div class="col s3 logo"><a class="modal-trigger" onClick=click_enabler('+i+') href="#modal1"><img src="http://placehold.it/150x150" class="waves-effect waves-light circle responsive-img hoverable"></a></div><div class="col s8"><div class="col s8"><div class="item_name">'+data[1][i][3]+' '+data[1][i][4]+'</div><div class="item_negotiable" style="margin-top:30px;">Price Negotiable: '+data[0][i][0][10]+'</div></div><div class="col s4"><div class="item_price z-depth-1">Price: '+data[0][i][0][5]+'</div><div class="item_link"><a href="'+data[0][i][0][9]+'">E-commerce Link</a></div></div></div></div></div>');
						// $('.check_item').append('<div class="row items card hoverable" style="width:80vw;"><div class="col s12 center-align"><div class="col s3 logo"><a class=" modal-trigger" onClick=click_enabler('+i+') href="#modal1"><img src="http://placehold.it/150x150" class="waves-effect waves-light circle responsive-img hoverable"></a></div><div class="col s8"><div class="col s6"><div class="item_name">'+data[1][i][3]+' '+data[1][i][4]+'</div><div class="item_negotiable" style="margin-top:20px;">Price Negotiable'+data[0][i][0][10]+'</div></div><div class="col s4"><div class="item_price col s4 z-depth-1">Price-'+data[0][i][0][5]+'</div><div class="item_link" style="margin-top:20px;"><a href="'+data[0][i][0][9]+'">E-commerce Link</a></div></div></div></div></div>');
						break;
					case 'head_charg_power_cam_cal':
						$('.check_item').append('<div class="row items card hoverable" style="width:80vw;"><div class="col s12 center-align"><div class="col s3 logo"><a class="modal-trigger" onClick=click_enabler('+i+') href="#modal1"><img src="http://placehold.it/150x150" class="waves-effect waves-light circle responsive-img hoverable"></a></div><div class="col s8"><div class="col s8"><div class="item_name">'+data[1][i][3]+' '+data[1][i][4]+'</div><div class="item_negotiable" style="margin-top:30px;">Price Negotiable: '+data[0][i][0][10]+'</div></div><div class="col s4"><div class="item_price z-depth-1">Price: '+data[0][i][0][5]+'</div><div class="item_link"><a href="'+data[0][i][0][9]+'">E-commerce Link</a></div></div></div></div></div>');
						//$('.check_item').append('<div class="row items card hoverable" style="width:80vw;"><div class="col s12 center-align"><div class="col s3 logo"><a class=" modal-trigger" onClick=click_enabler('+i+') href="#modal1"><img src="http://placehold.it/150x150" class="waves-effect waves-light circle responsive-img hoverable"></a></div><div class="col s8"><div class="col s6">'+data[1][i][3]+''+data[1][i][4]+'Price Negotiable'+data[0][i][0][10]+'</div><div class="col s4 z-depth-1">Price-'+data[0][i][0][5]+'<a href="'+data[0][i][0][9]+'"></a></div></div></div></div>');
						break;
					case 'cycle':
						$('.check_item').append('<div class="row items card hoverable" style="width:80vw;"><div class="col s12 center-align"><div class="col s3 logo"><a class="modal-trigger" onClick=click_enabler('+i+') href="#modal1"><img src="http://placehold.it/150x150" class="waves-effect waves-light circle responsive-img hoverable"></a></div><div class="col s8"><div class="col s8"><div class="item_name">'+data[1][i][3]+' '+data[1][i][4]+'</div><div class="item_negotiable" style="margin-top:30px;">Price Negotiable: '+data[0][i][0][10]+'</div></div><div class="col s4"><div class="item_price z-depth-1">Price: '+data[0][i][0][5]+'</div><div class="item_link"><a href="'+data[0][i][0][9]+'">E-commerce Link</a></div></div></div></div></div>');
						//$('.check_item').append('<div class="row items card hoverable" style="width:80vw;"><div class="col s12 center-align"><div class="col s3 logo"><a class=" modal-trigger" onClick=click_enabler('+i+') href="#modal1"><img src="http://placehold.it/150x150" class="waves-effect waves-light circle responsive-img hoverable"></a></div><div class="col s8"><div class="col s6">'+data[1][i][3]+''+data[1][i][4]+'Price Negotiable'+data[0][i][0][10]+'</div><div class="col s4 z-depth-1">Price-'+data[0][i][0][5]+'<a href="'+data[0][i][0][9]+'"></a></div></div></div></div>');
					...
					case 'furniture_music':
						$('.check_item').append('<div class="row items card hoverable" style="width:80vw;"><div class="col s12 center-align"><div class="col s3 logo"><a class="modal-trigger" onClick=click_enabler('+i+') href="#modal1"><img src="http://placehold.it/150x150" class="waves-effect waves-light circle responsive-img hoverable"></a></div><div class="col s8"><div class="col s8"><div class="item_name">'+data[1][i][3]+' '+data[1][i][5]+'</div><div class="item_negotiable" style="margin-top:30px;">Price Negotiable: '+data[0][i][0][10]+'</div></div><div class="col s4"><div class="item_price z-depth-1">Price: '+data[0][i][0][5]+'</div><div class="item_link"><a href="'+data[0][i][0][9]+'">E-commerce Link</a></div></div></div></div></div>');
						//$('.check_item').append('<div class="row items card hoverable" style="width:80vw;"><div class="col s12 center-align"><div class="col s3 logo"><a class=" modal-trigger" onClick=click_enabler('+i+') href="#modal1"><img src="http://placehold.it/150x150" class="waves-effect waves-light circle responsive-img hoverable"></a></div><div class="col s8"><div class="col s6">'+data[1][i][3]+''+data[1][i][5]+'Price Negotiable'+data[0][i][0][10]+'</div><div class="col s4 z-depth-1">Price-'+data[0][i][0][5]+'<a href="'+data[0][i][0][9]+'"></a></div></div></div></div>');
						break;
					case 'sports_equipment':
						$('.check_item').append('<div class="row items card hoverable" style="width:80vw;"><div class="col s12 center-align"><div class="col s3 logo"><a class="modal-trigger" onClick=click_enabler('+i+') href="#modal1"><img src="http://placehold.it/150x150" class="waves-effect waves-light circle responsive-img hoverable"></a></div><div class="col s8"><div class="col s8"><div class="item_name">'+data[1][i][6]+' '+data[1][i][3]+'</div><div class="item_negotiable" style="margin-top:30px;">Price Negotiable: '+data[0][i][0][10]+'</div></div><div class="col s4"><div class="item_price z-depth-1">Price: '+data[0][i][0][5]+'</div><div class="item_link"><a href="'+data[0][i][0][9]+'">E-commerce Link</a></div></div></div></div></div>');
						//$('.check_item').append('<div class="row items card hoverable" style="width:80vw;"><div class="col s12 center-align"><div class="col s3 logo"><a class=" modal-trigger" onClick=click_enabler('+i+') href="#modal1"><img src="http://placehold.it/150x150" class="waves-effect waves-light circle responsive-img hoverable"></a></div><div class="col s8"><div class="col s6">'+data[1][i][6]+''+data[1][i][3]+'Price Negotiable'+data[0][i][0][10]+'</div><div class="col s4 z-depth-1">Price-'+data[0][i][0][5]+'<a href="'+data[0][i][0][9]+'"></a></div></div></div></div>');
						break;	
				}
			}
		}
